...
class RegisterForm(forms.ModelForm):
    ...
    class Meta: # utilizamos para passar metadados do formulário para o django
        model = User
        fields = [
            'first_name',
            'last_name',
    ...
    def clean(self):
        cleaned_data = super().clean() # aqui pega todos os campos
